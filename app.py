...
Database.initialise(host='localhost', database='learning', user='postgres', password='7860')
...
def twitter_login():
    if 'screen_name' in session: #check if already logged in
...
@app.route('/auth/twitter') # http://127.0.0.1:4995/auth/twitter?oauth_verifier=12345
def twitter_auth():
